...
const config = {
    username:   "GDusername",   // Your gd username
    accountID:  "GDaccountid",  // Your gd account ID
    password:   "GDpassword",   // Your gd password
    text:       "Nice level.",  // The text you want to comment
